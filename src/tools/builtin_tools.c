...
static json_t *schema_shell_job_id(void)
{
...
int mcp_register_builtin_tools(struct mcp_server *server, struct mcp_tool_registry *registry)
{
    ...
    if (register_tool(registry,
                      ...
                      schema_with_properties(
                          json_pack("{s:{s:s,s:s},s:{s:s,s:s},s:{s:s,s:s,s:i,s:i},s:{s:s,s:s,s:i,s:i},s:{s:s,s:s},s:{s:s,s:s},s:{s:s,s:s}}",
                                    "command",
                                    "type",
                                    "string",
                                    "description",
                                    ...
                                    "integer",
                                    "description",
                                    "Optional per-stream output capture limit.",
                                    "minimum",
                                    256,
                                    "maximum",
                                    1048576,
    ...
    if (register_tool(registry,
                      ...
                      schema_with_properties(
                          json_pack("{s:{s:s,s:s},s:{s:s,s:s},s:{s:s,s:s},s:{s:s,s:s},s:{s:s,s:s}}",
                                    "job_id",
                                    "type",
                                    "string",
                                    "description",
                                    ...
                                    "integer",
                                    "description",
                                    "Compatibility offset applied to stdout and stderr.",
                                    "stdout_offset",
                                    "type",
                                    "integer",
                                    "description",
